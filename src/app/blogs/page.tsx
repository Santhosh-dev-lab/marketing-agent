...
export default function BlogsPage() {
    ...
    const MOCK_POSTS: Post[] = [
        ...
        { id: '5', title: 'Video Marketing Dominance', category: 'Content Strategy', read_time: '6 min read', excerpt: 'Short-form video remains king, but long-form is gaining traction for deeper engagement.', image_url: 'https://adistamedia.com/wp-content/uploads/2025/01/why-short-form-videos-1.jpg', created_at: new Date(Date.now() - 345600000).toISOString(), url: 'https://webilum.eu/en/dominance-of-video-marketing-and-short-form-content/' },
